...
def validate_file_size(file_size: int):
    if file_size > MAX_FILE_SIZE:
        raise AppException(
            status_code=400, message="File size exceeds the maximum limit of 5MB"
        )
...
def simulate_ocr_extraction():
    invoices = [
        {"invoice_number": "INV-001", "amount": 5000, "vendor": "Amazon"},
        {"invoice_number": "INV-002", "amount": 3000, "vendor": "Walmart"},
        {"invoice_number": "INV-003", "amount": 7000, "vendor": "Target"},
    ]
